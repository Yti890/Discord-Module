...
namespace Discord_Module.API.Other
{
    ...
    public sealed class Language
    {
        ...
        public Language()
        {
            jsonSerializer.Error += HandleJsonError;
            jsonSerializer.Formatting = Formatting.Indented;
        }

        public static string Folder { get; } = Path.Combine(LabApi.Loader.Features.Paths.PathManager.Configs.ToString(), "Lang-Configs");
        public string FullPath(string languageCode) => Path.Combine(Folder, $"{languageCode}.json");
        ...
        public string HasDamagedForWith { get; set; } = ":crossed_swords: **{0} ({1}) [{2}] has damaged {3} ({4}) [{5}].**";
        public string HasKilledWith { get; set; } = ":skull_crossbones: **{0} ({1}) [{2}] killed {3} ({4}) [{5}].**";
        ...
        public string HasPickedUp { get; set; } = ":package: {0} ({1}) [{2}] has picked up **{3}**.";
        public string HasDropped { get; set; } = ":package: {0} ({1}) [{2}] has dropped **{3}**.";
        ...
        public string UsedLocker { get; set; } = ":file_cabinet: {0} ({1}) [{2}] has opened a locker.";
        public string GeneratorClosed { get; set; } = ":electric_plug: {0} ({1}) [{2}] has closed a generator.";
        public string GeneratorOpened { get; set; } = ":electric_plug: {0} ({1}) [{2}] has opened a generator.";
        public string GeneratorEjected { get; set; } = ":package: {0} ({1}) [{2}] has ejected a tablet from a generator.";
        public string GeneratorFinished { get; set; } = ":white_check_mark: Generator in {0} has finished it's charge up, {1} generators have been activated.";
        ...
        public string Scp106WasContained { get; set; } = ":chains: {0} ({1}) [{2}] has been contained by the Femur Breaker.";
        public string Scp106CreatedPortal { get; set; } = ":door: {0} ({1}) [{2}] has created a portal.";
        public string Scp106Teleported { get; set; } = ":door: {0} ({1}) [{2}] has teleported to a portal.";
        public string GainedExperience { get; set; } = ":star: {0} ({1}) [{2}] has gained {3} XP ({4}).";
        public string GainedLevel { get; set; } = ":trophy: {0} ({1}) [{2}] has gained a level: {3} :arrow_right: {4}.";
        ...
        public string GroupSet { get; set; } = ":busts_in_silhouette: {0} ({1}) [{2}] has been assigned to the **{3} ({4})** group.";
        public string ItemChanged { get; set; } = ":package: {0} ({1}) [{2}] changed the item in their hand: {3} :arrow_right: {4}.";
        ...
        public string HandlingRemoteClient { get; set; } = "Handling remote command \"{0}\" with parameters: {1} from {2}.";
        public string HandlingRemoteClientError { get; set; } = "An error has occurred while handling a remote command: {0}";
        ...
        public string RetryingConnectionIn { get; set; } = "Retrying Reconect in ";
        public string AttemptingReconnect { get; set; } = "Trying to Reconnect...";
        ...
        public void Load(string languageCode)
        {
            ...
            if (!File.Exists(path))
            {
                Console.WriteLine($"Language file {path} not found, default language will be used.");
                return;
            }
            ...
            try
            {
                ...
                jsonSerializer.Populate(reader, this);
            }
            catch (Exception ex)
            {
